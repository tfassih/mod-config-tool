...
Config = {
	...
	BotSniperWorseningSkill = 0.40,		-- See BotWorseningSkill - only for BOTs using sniper bolt-action rifles 
	ReactionTime = 0.3,					-- Additional delay for bots, dependant of skill (might also be 0) 
	...
	VehicleAimWorsening = 0.25,			-- Make bots in vehicles aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy) 
	...
	NewBotsPerNewPlayer = 2.0,			-- Number to increase Bots by when new players join 
	...
	MaxReconBots = 4,					-- Maximum number of Bots with Recon Kit. -1 = no limit 
	...
	MaxDistanceShootBackSniper = 300,	-- Meters until snipers shoot back if hit 
	...
	BotCanKillHimself = true,			-- Bot takes fall damage or explosion-damage from own frags 
